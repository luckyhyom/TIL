          ...
          case "Stone Color":
            ...
            switch (optionText) {
              case "White":
                ...
                jQuery3_6_0("div[optionName=whiteStone]").show();
                break;
              case "Red":
                jQuery3_6_0("div[optionName$=Stone]").hide();
                jQuery3_6_0("div[optionName=redStone]").show();
                break;
              case "Blue":
                jQuery3_6_0("div[optionName$=Stone]").hide();
                jQuery3_6_0("div[optionName=blueStone]").show();
                break;
              case "Black":
                jQuery3_6_0("div[optionName$=Stone]").hide();
                jQuery3_6_0("div[optionName=blackStone]").show();
                break;
              default:
                break;
            }
          ...
          case "Metal Color":
            switch (optionText) {
              case "Yellow":
                ...
                jQuery3_6_0("div[optionName=yellowMetal]").show();
                break;
              case "Rose":
                jQuery3_6_0("div[optionName$=Metal]").hide();
                jQuery3_6_0("div[optionName=roseMetal]").show();
                break;
              case "White":
                jQuery3_6_0("div[optionName$=Metal]").hide();
                jQuery3_6_0("div[optionName=whiteMetal]").show();
                break;
              default:
                break;
            }
